        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('imagenes/banner1.jpg') }}" class="d-block w-100"
                        alt="dos personas haciendo brindis con las copas de vino">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('imagenes/banner3.jpg') }}" class="d-block w-100"
                        alt="paisaje con plantas de parra">
                    <div class="carousel-caption d-none d-md-block">
            ...
            @foreach ($blogs as $index => $blog)
                <div class="col-12 mb-4"> <!-- Ancho completo -->
                    <div class="cardBlog" style="display: flex; flex-direction: row; align-items: center;">
                        ...
                        @else
                            <img src="{{ Storage::disk('blog')->url($blog->imagen) }}" alt="{{ $blog->titulo }}"
                                style="width: 25%; height: auto; margin-left: 20px;">
                        @endif
                        ...
                        <div class="card-footer">
                            <a href="{{ route('publicaciones.show', ['blog' => $blog]) }}" class="btn btn-primary">Más
                                Información</a>
                        </div>
                    </div>
                </div>
